...
return [
    ...
    'article_delete' => [['id'], ['_controller' => 'App\\Controller\\BlogController::delete'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id', true], ['text', '/articles']], [], []],
    'security' => [[], ['_controller' => 'App\\Controller\\SecurityController::registration'], [], [['text', '/inscription']], [], []],
