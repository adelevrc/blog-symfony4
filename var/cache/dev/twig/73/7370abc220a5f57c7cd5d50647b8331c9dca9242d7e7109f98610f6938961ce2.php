...
class __TwigTemplate_40fb7c5f454bfe6befc7284a21de733280474360c671883a476bf582406f0ea4 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "email", [], "any", false, false, false, 11), 'row', ["label" => "Adresse email", "attr" => ["placeholder" => "Adresse email"]]);
        echo "
\t";
        // line 12
...
\t";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "confirm_password", [], "any", false, false, false, 13), 'row', ["label" => "Confirmation du mot de passe", "attr" => ["placeholder" => "Confirmation du mot de passe"]]);
        echo "
...
";
    ...
    {
        return array (  98 => 18,  90 => 13,  86 => 12,  82 => 11,  78 => 10,  74 => 9,  68 => 5,  58 => 4,  35 => 1,);
    }
...
\t{{ form_row(form.confirm_password, {'label' : 'Confirmation du mot de passe', 'attr' : {'placeholder': 'Confirmation du mot de passe'}}) }}
...
{% endblock %}
", "security/registration.html.twig", "/Users/adelevercaygne/Desktop/Symfony/demo/templates/security/registration.html.twig");
    }
}
